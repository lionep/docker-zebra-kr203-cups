...
RUN apt-get update && apt-get install -y \
    ...
    libasprintf0v5 libc6-i386 libfile-stripnondeterminism-perl libgettextpo-dev libgettextpo0 libjpeg62 liblua5.2-0 liblzo2-2 libmail-sendmail-perl libnspr4 libnss3 libpipeline1 libpopt0 \
    libsigsegv2 libsys-hostname-long-perl libtimedate-perl locales lsb lsb-core lsb-invalid-mta lsb-printing lsb-security m4 man-db ncurses-term pax po-debconf \
